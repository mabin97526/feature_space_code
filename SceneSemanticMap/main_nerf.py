...
if __name__ == '__main__':
    ...
    parser.add_argument('--cuda_ray', action='store_true', help="use CUDA craymarching instead of pytorch")
    ...
    if opt.test:
        ...
        if opt.gui:
            ...
            test_loader = NeRFDataset(opt, device=device, type='test',downscale=opt.down_scale).dataloader()
            ...
            trainer.test(test_loader, write_video=opt.write_video) # test and save video
        ...
        train_loader = NeRFDataset(opt, device=device, type='train',downscale=opt.down_scale).dataloader()
        ...
        if opt.gui:
            ...
            valid_loader = NeRFDataset(opt, device=device, type='val', downscale=opt.down_scale).dataloader()
