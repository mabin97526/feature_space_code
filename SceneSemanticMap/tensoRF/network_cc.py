...
class NeRFNetwork(NeRFRenderer):
    def __init__(self,
                ...
                #  rank_vec=[64],
                #  rank_mat=[64],
                 rank_vec_density=None,
                 rank_mat_density=None,
                 rank_vec=None,
                 rank_mat=None,
                 bg_resolution=None,
                 bg_rank=8,
    ...
    def compose(self, other, R=None, s=None, t=None): 
        ...
        # first scale & rotate, then translate. [0,1,2,3]
        #                                       [0,1,2,3]
