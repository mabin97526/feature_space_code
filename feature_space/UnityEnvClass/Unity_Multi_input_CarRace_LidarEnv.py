...
class UnityBaseEnv(gym.Env):
    ...
    def observation_space(self):
        ...
        obs_shape = gymnasium.spaces.Dict(spaces={"image": obs_1,"semanticlidar":obs_1,"ray":obs_2,"speed":obs_3}, seed=42)
        #print(obs_shape)
    ...
    def reset(self):
        ...
        obs = self._env.reset()
        obs = {"image": obs[0],"semanticlidar":obs[1],"ray": obs[2][0:802],"speed": obs[2][802:804]}
        return obs,{}
