...
class UnityBaseEnv(gym.Env):
    ...
    def observation_space(self):
        ...
        obs_2 = spaces.Box(low=-math.inf,high=math.inf,shape=(158,),dtype=np.float32)
        ...
        obs_shape = gymnasium.spaces.Dict({ "ray":obs_2}, seed=42)
        #print(obs_shape)
    ...
    def action_space(self):
        ...
        action_space = spaces.Box(low=-1.0,high=1.0,shape=(20,),dtype=np.float32)
        return action_space
