...
class UnityBaseEnv(gym.Env):
    ...
    def observation_space(self):
        ...
        obs_4 = spaces.Box(low=-math.inf,high=math.inf,shape=(42,),dtype=np.float32)

        #obs_shape = gymnasium.spaces.Tuple((obs_1,obs_2),seed=42)
        obs_shape = gymnasium.spaces.Dict(spaces={"image": obs_1,"semantic": obs_1,"semantic_random":obs_1, "ray":obs_2, "speed":obs_3,"objectDet":obs_4}, seed=42)
        #print(obs_shape)
    ...
    def reset(self):
        self._rewards = []
        obs = self._env.reset()
        obs = {"image": obs[0], "ray": obs[3][42:844],"speed": obs[3][844:850],"semantic":obs[2],"semantic_random":obs[1],"objectDet":obs[3][0:42]}
        return obs,{}
