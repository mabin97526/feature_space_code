...
class UnityBaseEnv(gym.Env):
    ...
    def observation_space(self):
        ...
        obs_3 = spaces.Box(low=-math.inf,high=math.inf,shape=(42,),dtype=np.float32)
        obs_4 = spaces.Box(low=-math.inf,high=math.inf,shape=(2,),dtype=np.float32)

        #obs_shape = gymnasium.spaces.Tuple((obs_1,obs_2),seed=42)
        obs_shape = gymnasium.spaces.Dict(spaces={"image": obs_1, "semantic":obs_1,"ray":obs_2,"objectDet":obs_3,"speed":obs_4}, seed=42)
        #print(obs_shape)
    ...
    def reset(self):
        ...
        obs = {"image": obs[0], "semantic":obs[1],"ray": obs[2][42:844],"objectDet": obs[2][0:42],"speed": obs[2][844:846]}
        return obs,{}
