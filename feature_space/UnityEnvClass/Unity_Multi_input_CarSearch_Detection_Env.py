...
class UnityBaseEnv(gym.Env):
    ...
    def observation_space(self):
        ...
        obs_shape = gymnasium.spaces.Dict(spaces={"image": obs_1, "ray":obs_2, "speed":obs_3,"objectDet":obs_4}, seed=42)
        return obs_shape
    ...
    def reset(self):
        self._rewards = []
        obs = self._env.reset()
        obs = {"image": obs[0], "ray": obs[2][42:844],"speed": obs[2][844:850],"semantic":obs[1],"objectDet":obs[2][0:42]}
        return obs,{}
