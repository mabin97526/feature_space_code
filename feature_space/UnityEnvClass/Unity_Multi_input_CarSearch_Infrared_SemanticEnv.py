...
class UnityBaseEnv(gym.Env):
    ...
    def observation_space(self):
        ...
        obs_2 = spaces.Box(low=0,high=255,shape=(84,84,3),dtype=np.uint8)
        ...
        obs_shape = gymnasium.spaces.Dict(spaces={"image": obs_1,"semantic":obs_2,"speed":obs_3}, seed=42)
        #print(obs_shape)
    ...
    def reset(self):
        ...
        obs = self._env.reset()
        obs = {"image": obs[0],"semantic":obs[1],"speed": obs[2]}
        return obs,{}
