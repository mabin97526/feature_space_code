...
class UnityBaseEnv(gym.Env):
    ...
    def observation_space(self):
        ...
        obs_4 = spaces.Box(low=0,high=255,shape=(84,84,1),dtype=np.uint8)
        #obs_shape = gymnasium.spaces.Tuple((obs_1,obs_2),seed=42)
        obs_shape = gymnasium.spaces.Dict(spaces={"image":obs_1,"semantic":obs_1,"infrared":obs_4,"ray":obs_2,"speed":obs_3}, seed=42)
        #print(obs_shape)
    ...
    def reset(self):
        ...
        obs = self._env.reset()
        obs = {"infrared":obs[0],"semantic":obs[2],"image":obs[1],"ray": obs[3][0:802],"speed": obs[3][802:804]}
        return obs,{}
