...
if __name__ == '__main__':
    ...
    env_name = "CarSearchInfraredSemantic"
    Algorithm = "TD3"
    new_logger = configure("./loggers/{}_{}_logger".format(Algorithm,env_name) + timestamp, ["stdout", "csv", "tensorboard"])
    env = make_unity_env(UnityEnvClass.Unity_Multi_input_CarSearch_Infrared_SemanticEnv.UnityBaseEnv, n_envs=5, env_kwargs=dict(file_name="../../UnityEnv/CarSearchInfraredSemantic/RLEnvironments.exe", time_scale=10,max_steps=1000))
    #REDQ
