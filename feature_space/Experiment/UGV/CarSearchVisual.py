import time
import UnityEnvClass.Unity_Multi_input_CarSearchNormal_Env, UnityEnvClass.Unity_Multi_input_CarRace_InfraredEnv,UnityEnvClass.Unity_Multi_input_CarSearch_Visual_Env
...
if __name__ == '__main__':
    ...
    env_name = "CarSearchNoVisualSemantic"
    Algorithm = "PPO"
    new_logger = configure("./loggers/{}_{}_logger".format(Algorithm,env_name) + timestamp, ["stdout", "csv", "tensorboard"])
    env = make_unity_env(UnityEnvClass.Unity_Multi_input_CarSearch_Visual_Env.UnityBaseEnv, n_envs=5, env_kwargs=dict(file_name="../../UnityEnv/CarSearchVisual/RLEnvironments.exe", time_scale=10,max_steps=1000))
    #REDQ
