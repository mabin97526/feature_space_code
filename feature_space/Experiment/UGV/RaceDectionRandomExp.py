...
from UnityEnvClass import Unity_RollerBall, Unity_3Dball, Unity_3DballVision, Unity_Base_env,Unity_Multi_input_CarRace_BoundingBox_SemanticEnv,Unity_Multi_input_CarRace_SemanticEnv
...
if __name__ == '__main__':
    ...
    env = make_unity_env(UnityEnvClass.Unity_Multi_input_CarRace_SemanticEnv.UnityBaseEnv, n_envs=5,start_index=15, env_kwargs=dict(file_name="../../UnityEnv/RaceDeploy/RLEnvironments.exe", time_scale=10,max_steps=2000))
    ...
    model = PPO("MultiInputPolicy",env,verbose=1,device="cuda",learning_rate=3e-4,seed=42,gamma=0.99,policy_kwargs=policy_kwargs,use_siamese=True,adjust_learning_rate=True)
