...
if __name__ == '__main__':
    ...
    env_name = "CarSearchNoInfraredSemantic"
    Algorithm = "TQC"
    new_logger = configure("./loggers/{}_{}_logger".format(Algorithm,env_name) + timestamp, ["stdout", "csv", "tensorboard"])
    env = make_unity_env(UnityEnvClass.Unity_Multi_input_CarSearch_InfraredEnv.UnityBaseEnv, n_envs=5, env_kwargs=dict(file_name="../../UnityEnv/CarSearchInfrared/RLEnvironments.exe", time_scale=10,max_steps=1000))
    #REDQ
