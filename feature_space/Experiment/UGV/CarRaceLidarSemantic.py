...
if __name__ == '__main__':
    ...
    env_name = "CarRaceLidarSemantic"
    Algorithm = "TD3"
    new_logger = configure("./loggers/{}_{}_logger".format(Algorithm,env_name) + timestamp, ["stdout", "csv", "tensorboard"])
    env = make_unity_env(UnityEnvClass.Unity_Multi_input_CarSearch_Lidar_SemanticEnv.UnityBaseEnv, n_envs=5,start_index=0, env_kwargs=dict(file_name="../../UnityEnv/CarRaceLidarSemantic/RLEnvironments.exe", time_scale=10,max_steps=1000))
    #REDQ
