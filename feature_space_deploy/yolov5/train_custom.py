...
from yolo_utils.loss import ComputeLoss, SegmentationLosses, SegFocalLoss, OhemCELoss, ProbOhemCrossEntropy2d
from yolo_utils.plots import plot_images, plot_labels, plot_results, plot_evolution
from yolo_utils.torch_utils import ModelEMA, select_device, intersect_dicts, torch_distributed_zero_first, is_parallel
from yolo_utils.wandb_logging.wandb_utils import WandbLogger, check_wandb_resume
...
def train(hyp, opt, device, tb_writer=None):
    ...
    #    seg_valloader = SegmentationDataset.get_citysbdd_loader(root=segval_path, batch_size=8,
