...
Labscene_Class = ["S_Obs", "R_Car", "W_Car", "B_Car", "B_Target",
               "Y_Object", "Wall", "Plane", "_background_"]
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if view_img:
                ...
                cv2.imshow("mix", dst)
                cv2.waitKey(1)&0xff == ord('q')# 1 millisecond
            if opt.submit:
                ...
                if True:
                    ...
                    if vid_path != save_path:  # new video
                        ...
                        if vid_cap:  # video
                            ...
                            save_path += '.mp4'
                            save_path1 = 'im0' + save_path
                            save_path2 += 'mask' + save_path
                        vid_writer = cv2.VideoWriter(save_path, cv2.VideoWriter_fourcc(*'mp4v'), fps, (w, h))
                        vid_writer1 = cv2.VideoWriter(save_path1, cv2.VideoWriter_fourcc(*'mp4v'), fps, (w, h))
